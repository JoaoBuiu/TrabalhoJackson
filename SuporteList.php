<?php
    include "./controller/SuporteController.php";
        ...
        if(!empty($_GET['id'])){
            $suporte->deletar($_GET['id']);
            header("location: SuporteList.php");
        }

        if(!empty($_POST)){
            $load = $suporte->pesquisar($_POST);
        }
        else{
            $load = $suporte->carregar();
        }
?>
          ...
          <table>
            ...
            <?php
                foreach($load as $item){
                    ...
                    <td>$item->assunto</td>
                    <td>$item->data</td>
                    <td id='dgrey'><a href='./SuporteForm.php?id=$item->id'><img src='./public/icons/editar.svg' id='edit'/></a></td>
                    <td id='dgrey'><a href='./SuporteList.php?id=$item->id'
